        ...
        <div class="flex h-16 justify-between">
            ...
            <div class="hidden items-center sm:ms-6 sm:flex">
                <x-dropdown align="right" width="56">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-medium leading-4 text-slate-600 shadow-sm transition hover:border-brand-primary/20 hover:text-brand-primary focus:outline-none">
